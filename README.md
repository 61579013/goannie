...
\ \____ \ \____/\ \__/.\_\ \_\ \_\ \_\ \_\ \_\ \____\
 \/___L\ \/___/  \/__/\/_/\/_/\/_/\/_/\/_/\/_/\/____/
   /\____/
   \_/__/
        version: v0.0.08        updateTime: 2020-08-27
...
cookie 设置：在goannie.exe同级目录中新建 ./tengxun.txt 写入cookie=xxx;xxx=xxx;格式即可。
...
cookie 设置：在goannie.exe同级目录中新建 ./iqiyi.txt 写入cookie=xxx;xxx=xxx;格式即可。
...
cookie 设置：在goannie.exe同级目录中新建 ./xigua.txt 写入cookie=xxx;xxx=xxx;格式即可。

|-----------------       好看视频       -----------------|
task: userList  info: 作者视频  https://haokan.baidu.com/author/1649278643844524
cookie 设置：在goannie.exe同级目录中新建 ./haokan.txt 写入cookie=xxx;xxx=xxx;格式即可。

|-----------------       哔哩哔哩       -----------------|
task: userList  info: TA的视频  https://space.bilibili.com/337312411
cookie 设置：在goannie.exe同级目录中新建 ./bilibili.txt 写入cookie=xxx;xxx=xxx;格式即可。

下载统计
腾讯视频：0  爱奇艺视频：0  好看视频：0  哔哩哔哩：4  西瓜视频：0
```